...
namespace Orc.Analytics.Auditors
{
    ...
    {
        public AnalyticsAuditor(Orc.Analytics.IGoogleAnalyticsService analyticsService) { }
...
namespace Orc.Analytics
{
    ...
    public class GoogleAnalyticsService : Orc.Analytics.IGoogleAnalyticsService
    {
